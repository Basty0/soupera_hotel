...
@section('content')
    <div class="row m-2" style="display: flex; justify-content: center; align-items: center;">
        @foreach ($chambre as $chambr)
            <div class="col col-md-3 p-3 col-12 bg-white border m-2 rounded-3">
    ...
    @endif
    <div class="container-fluid border rounded-3 bg-white">

        <div class="row mt-3 bg-gradient-dark rounded-5 border p-4">
            <div class="col-col-md-4 col-12 text-center mb-2">
                <a id="afficherA" class="bg-gradient-success py-3 px-3 rounded-5">Réservation en cour</a>
            </div>
            <div class="col text-center col-md-4 col-12 mt-4">
                <a id="afficherB" class="bg-gradient-secondary  py-3 px-3 rounded-5 ml-2">Réservation finie</a>
        ...
        <div class="row   mt-3 mb-3 ">
            <div id="contenuA" class=" mt-3  ">
                ...
                <div>
                    <table class="table  text-center text-center border rounded-3">
                        <thead class="">
                            <tr>
                                <th scope="col"></th>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark">
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('reservation.fin', ['id' => $reservation->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-primary dropdown-item">Terminer la
                                                            réservation</button>
                                                    </form>
                                                </li>
            ...
            <div id="contenuB" class="mt-3  ">
                ...
                <div>
                    <table class="table  text-center border rounded-3">
                        <thead class="">
                            <tr>
                                <th scope="col">Chambre</th>
                                <th scope="col">Design</th>
